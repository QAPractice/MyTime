...
public class LoginOlegTest {
    ...
    public void testLoginOlegTest_TC1338() throws Exception {
        ...
        for (int second = 0; ; second++) {
            ...
            try {
                if (isElementPresent(By.id("polelogin"))) break;
            } catch (Exception e) {
            }
            Thread.sleep(1000);
        }
        ...
        driver.findElement(By.id("polelogin")).sendKeys("oshil3321@gmail.com");
        driver.findElement(By.id("password")).clear();
        driver.findElement(By.id("password")).sendKeys("3321ol");
        for (int second = 0; ; second++) {
            if (second >= 60) fail("timeout");
            try {
                if (isElementPresent(By.id("1"))) break;
            } catch (Exception e) {
            }
            Thread.sleep(1000);
        }
        ...
        for (int second = 0; ; second++) {
            if (second >= 60) fail("timeout");
            try {
                if (isElementPresent(By.xpath("//div[@id='second']/div/p"))) break;
            } catch (Exception e) {
            }
            Thread.sleep(1000);
        }
